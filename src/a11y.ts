...
const labels = document.querySelectorAll("label[tabindex='0']") as NodeListOf<HTMLElement>;
const inputs = document.querySelectorAll("input[tabindex='0']") as NodeListOf<HTMLInputElement>;
...
function handleEnterKey(event: KeyboardEvent) {
    if (event.key === "Enter") {
       ...
       if (activeElement && activeElement.tagName === "LABEL") {
        ...
        const radio = document.getElementById(inputId as string) as HTMLInputElement;
